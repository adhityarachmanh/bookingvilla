    ...
    <v-img :src="image" :gradient="sidebarOverlayGradiant" height="100%">
      <v-layout class="fill-height" tag="v-list" column>
        <v-list-tile avatar>
          ...
          <v-list-tile-title class="title">{{admin&&admin.nama}}</v-list-tile-title>
        </v-list-tile>
        <v-divider />
...
export default {
  data: () => ({
    ...
    links: [
      ...
      {
        to: "/admin/booking-list/success",
        icon: "mdi-clipboard-outline",
        text: "Booking Villa (Success)"
      },
          {
        to: "/admin/booking-list/waiting",
        icon: "mdi-clipboard-outline",
        text: "Booking Villa (Waiting)"
      },
      {
        to: "/admin/chat",
        icon: "mdi-message",
